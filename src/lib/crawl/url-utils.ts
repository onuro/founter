// URL utility functions for crawl image extraction
...
export function getLargerImageUrl(url1: string, url2: string): string {
...
export function parseSrcset(srcset: string): SrcsetEntry | null {
...
export function extractWidthFromUrl(url: string): number | null {
